...
OverText es una app de menubar para macOS que corrige texto seleccionado usando OpenAI. Está pensada para usarse desde cualquier app posible del sistema mediante un atajo global, `Services` de macOS y `Accessibility`.
...
- `Corregir con AI`
- `Corregir con AI (Token efficent)`
